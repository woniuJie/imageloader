 ...
 */
public class ZoomableDraweeView extends CustomImageView
    ...
    private final GestureListenerWrapper mTapListenerWrapper = new GestureListenerWrapper(this) {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mOnClickListener != null) {
                mOnClickListener.onClick(ZoomableDraweeView.this);
            }
     ...
     * 调用时要放在onClickListener、onLongClickListener之后否则会被覆盖掉
     */
    ...
    /**
     * 因为重写了onTouchEvent事件所以原生的onclick,onLongclick不生效了
     */
    @Override
